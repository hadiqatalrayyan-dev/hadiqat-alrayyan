...
class ArticleResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $ogImageUrl = $this->og_image;
        if ($ogImageUrl && !str_starts_with($ogImageUrl, 'http') && !str_starts_with($ogImageUrl, '/')) {
            $ogImageUrl = '/storage/' . $ogImageUrl;
        }
        ...
        return [
            ...
            'seo'         => [
                ...
                'ogImage'         => $ogImageUrl ?: ($imageUrl ?: '/images/og-image.webp'),
            ],
            'content'     => [
