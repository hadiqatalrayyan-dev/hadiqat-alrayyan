...
export const metadata: Metadata = {
  title: "جميع خدمات تنسيق الحدائق بالرياض | مؤسسة حدائق المستقبل",
  description: "دليلك الشامل لكافة خدمات تنسيق وتصميم الحدائق، توريد وتركيب العشب الصناعي والطبيعي، الشلالات، المظلات، البرجولات وشبكات الري بالرياض مع ضمان معتمد حتى 7 سنوات ومعاينة 3D مجانية. اتصل: 0560877272",
  keywords: [
    "خدمات تنسيق حدائق",
    "تنسيق حدائق بالرياض",
    "تصميم حدائق فلل",
