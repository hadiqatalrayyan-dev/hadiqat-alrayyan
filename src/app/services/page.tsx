...
export const metadata: Metadata = {
  ...
  description: "دليلك الشامل لكافة خدمات تنسيق وتصميم الحدائق، توريد وتركيب العشب الصناعي والطبيعي، الشلالات، المظلات، والبرجولات بالرياض وجدة وكافة مدن المملكة. اتصل الآن: 0560877272",
  keywords: [
    "خدمات تنسيق حدائق",
    "تنسيق حدائق بالرياض",
    "تنسيق حدائق بجدة",
