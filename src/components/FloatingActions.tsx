  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 flex flex-col items-end gap-3 select-none">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 bg-[#10b981] hover:bg-[#059669] text-white font-bold text-sm px-5 py-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-emerald-500/30"
      ...
      <a
        ...
        className="inline-flex items-center gap-2 bg-[#0284c7] hover:bg-[#0369a1] text-white font-bold text-sm px-5 py-3 rounded-full shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-blue-500/30"
