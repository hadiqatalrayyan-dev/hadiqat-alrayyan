...
import { X, CheckCircle2, Phone, MessageCircle, ArrowRight } from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
      ...
      >
        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
          ...
          {/* Features */}
          <div>
            <h4 className="text-sm font-bold text-gray-900 mb-3">أهم مميزات الخدمة مع حدائق المستقبل:</h4>
          ...
          <div className="pt-4 border-t border-gray-100 flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white font-bold py-3.5 px-4 rounded-xl shadow-md transition-colors"
            >
            ...
            <a
              ...
              className="flex-1 inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold py-3.5 px-4 rounded-xl shadow-md transition-colors"
            >
