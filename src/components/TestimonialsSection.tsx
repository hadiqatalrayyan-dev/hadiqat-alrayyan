...
const customerReviews: TestimonialSlide[] = [
  {
    id: 1,
    rating: 5,
    headline: "مؤسسة حدائق الريان لتنسيق الحدائق تمكنت من تصميم حديقة منزلي بشكل رائع في زمن قياسي",
    comment:
      "قامت مؤسسة حدائق الريان بعمل تصميم لحديقة منزلي واختباره قبل التركيب وعمل التعديلات التي طلبتها منهم بحرفية وإتقان. حقاً أفضل شركة تنسيق حدائق في السعودية!",
